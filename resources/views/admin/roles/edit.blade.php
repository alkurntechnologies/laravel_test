                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" disabled
                                    id="name" placeholder="Enter name" required=""  data-parsley-required-message="Please enter name." value="{{$row->name}}">
                            @if ($errors->has('name'))
                                        ...
                                        <td>
                                            <div class="checkbox checkbox-primary">
                                                <input id="c{{ $name }}" type="checkbox" class="checkbox-row"
                                                    {{ $row->permissions->whereIn('id', $permission->pluck('id'))->count() === 4 ? 'checked="checked"' : '' }}
                                                >
                                        ...
                                        <td>
                                            <div class="checkbox checkbox-primary">
                                                <input id="c{{ $permission[0]->id }}" type="checkbox"
                                                       ...
                                                       class="checkbox-item"
                                                       name="permissions[]"
                                                    {{ $row->permissions->where('id', $permission[0]->id)->count() ? 'checked="checked"' : '' }}
                                                >
                                        ...
                                        <td>
                                            <div class="checkbox checkbox-primary">
                                                <input id="c{{ $permission[1]->id }}" type="checkbox"
                                                       ...
                                                       class="checkbox-item"
                                                       name="permissions[]"
                                                    {{ $row->permissions->where('id', $permission[1]->id)->count() ? 'checked="checked"' : '' }}
                                                >
                                        ...
                                        <td>
                                            <div class="checkbox checkbox-primary">
                                                <input id="c{{ $permission[2]->id }}" type="checkbox"
                                                       ...
                                                       class="checkbox-item"
                                                       name="permissions[]"
                                                    {{ $row->permissions->where('id', $permission[2]->id)->count() ? 'checked="checked"' : '' }}
                                                >
                                        ...
                                        <td>
                                            <div class="checkbox checkbox-primary">
                                                <input id="c{{ $permission[3]->id }}" type="checkbox"
                                                       ...
                                                       class="checkbox-item"
                                                       name="permissions[]"
                                                    {{ $row->permissions->where('id', $permission[3]->id)->count() ? 'checked="checked"' : '' }}
                                                >
